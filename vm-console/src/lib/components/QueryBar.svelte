<script lang="ts">
  ...
  import { CornerDownLeft, History, Loader2, Play } from "@lucide/svelte";
  ...
  function onKeyDown(event: KeyboardEvent) {
    // Enter runs, Shift+Enter breaks the line — the convention every query
    // console shares, and the reason this is a textarea rather than an input.
  ...
  <div class="flex items-start gap-2">
    <div class="relative flex-1">
      <Textarea
        ...
        class="bg-card min-h-[4.25rem] resize-y pr-24 font-mono text-[13px] leading-relaxed"
      />
      <div
